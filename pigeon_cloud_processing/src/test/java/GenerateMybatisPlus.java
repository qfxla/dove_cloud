...
public class GenerateMybatisPlus {
    ...
    public void generate() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/pigeon_cloud_processor?useSSL=true&characterEncoding=UTF-8&serverTimezone=UTC");
...
//        pc.setXml("mapping"); // 默认是默认是mapper.xml
        ...
        strategy.setInclude("t_dove_processing","t_processing_technology","t_processing_type","t_processing_flow","t_business_processing","t_out_processing","t_processing_batch","t_out_processing_bill"); // 需要生成的表 设置要映射的表名
