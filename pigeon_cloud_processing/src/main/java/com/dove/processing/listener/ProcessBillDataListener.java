...
public class ProcessBillDataListener extends AnalysisEventListener<OutProcessingBillVo> {
    ...
    List<OutProcessingBillVo> list = new ArrayList<>();
    /**
     ...
     *
     * @param outProcessingBillService
     */
    public ProcessBillDataListener(OutProcessingBillService outProcessingBillService) {
        this.outProcessingBillService = outProcessingBillService;
    }
    /**
     * 这个每一条数据解析都会来调用
     *
     ...
     */
    @Override
    public void invoke(OutProcessingBillVo data, AnalysisContext context) {
    ...
    private void saveData() {
        ...
        outProcessingBillService.saveList(list);
        LOGGER.info("存储数据库成功！");
    }
}
